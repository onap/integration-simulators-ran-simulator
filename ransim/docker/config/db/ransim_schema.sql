...
drop table if exists celldetails; 
drop table if exists cellneighbor; 
drop table if exists cellneighbor_neighbordetails; 
drop table if exists neighbordetails; 
drop table if exists netconfservers; 
drop table if exists netconfservers_celldetails; 
drop table if exists operationlog; 

-- -----------------------------------------------------
-- Table `ransim_db`.`celldetails`
-- -----------------------------------------------------
create table celldetails (
        ...
        nodeName varchar(225),
        nodeType varchar(225),
        pciCollisionDetected bit(1) not null,
        pciConfusionDetected bit(1) not null,
        physicalCellId bigint(20) not null,
        screenX float not null,
        screenY float not null,
...
-- -----------------------------------------------------
-- Table `ransim_db`.`cellneighbor`
-- -----------------------------------------------------
create table cellneighbor (
        nodeId  varchar(52) not null,
        primary key (nodeId)
    ) engine=InnoDB;

-- -----------------------------------------------------
-- Table `ransim_db`.`cellneighbor_neighbordetails`
-- -----------------------------------------------------
create table cellneighbor_neighbordetails(
        CellNeighbor_nodeId varchar(52) not null,
        neighborList_neighborCellNodeId varchar(225) not null,
        neighborList_sourceCellNodeId varchar(225) not null,
        primary key (CellNeighbor_nodeId,neighborList_neighborCellNodeId,neighborList_sourceCellNodeId)
    ) engine=InnoDB;

-- -----------------------------------------------------
-- Table `ransim_db`.`neighbordetails`
-- -----------------------------------------------------
create table neighbordetails (
        neighborCellNodeId varchar(225) not null,
        sourceCellNodeId varchar(225) not null,
        blacklisted bit(1) not null,
        primary key (neighborCellNodeId,blacklisted)
    ) engine=InnoDB;

-- -----------------------------------------------------
-- Table `ransim_db`.`netconfservers`
-- -----------------------------------------------------
create table netconfservers (
...
-- -----------------------------------------------------
-- Table `ransim_db`.`netconfservers_celldetails`
-- -----------------------------------------------------
create table netconfservers_celldetails (
        NetconfServers_serverId varchar(20) not null,
        cells_nodeId varchar(50) not null,
        primary key (NetconfServers_serverId,cells_nodeId)
    ) engine=InnoDB;

-- -----------------------------------------------------
-- Table `ransim_db`.`operationlog`
-- -----------------------------------------------------
